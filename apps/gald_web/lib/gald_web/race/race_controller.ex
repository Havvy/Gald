defmodule GaldWeb.RaceController do
  ...
  def index(conn, _params) do
    ...
    render conn, "lobby.html", races: GaldWeb.RaceManager.all(), csrf: token
  end
  ...
  def create(conn, ~m{visible_name profile}) do
    ...
    internal_race_name = GaldWeb.RaceManager.start_race(config)
